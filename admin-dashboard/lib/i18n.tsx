...
const messages: Record<AdminLanguage, Messages> = {
  en: {
    ...
    // NRS Operations Center
    'nrsOps.pageTitle': 'NRS Operations Center',
    'nrsOps.pageDesc': 'Real-time NRS (Nigeria Revenue Service) submission monitoring',
    'nrsOps.autoRefresh': 'Auto-refresh every 10 s',
    'nrsOps.health.title': 'NRS Submission Health — Last 24 Hours',
    'nrsOps.health.successful': '{count} successful',
    'nrsOps.health.failed': '{count} failed',
    'nrsOps.health.pending': '{count} pending',
    'nrsOps.health.total': 'Total: {count}',
    'nrsOps.queue.section': 'Queue Status',
    'nrsOps.queue.unavailable': 'Queue data unavailable — Redis may be initialising.',
    'nrsOps.queue.failedCount': '{count} failed',
    'nrsOps.queue.waiting': 'waiting',
    'nrsOps.queue.active': 'active',
    'nrsOps.queue.done': 'done',
    'nrsOps.table.section': 'Failed Submissions',
    'nrsOps.table.heading': 'Failed / Pending Submissions',
    'nrsOps.table.totalCount': '{count} total',
    'nrsOps.table.empty': 'No failed submissions — NRS pipeline is healthy',
    'nrsOps.table.col.invoice': 'Invoice #',
    'nrsOps.table.col.status': 'Status',
    'nrsOps.table.col.amount': 'Amount (₦)',
    'nrsOps.table.col.error': 'Error',
    'nrsOps.table.col.updated': 'Updated',
    'nrsOps.table.col.action': 'Action',
    'nrsOps.table.resubmit': 'Re-submit',
    'nrsOps.table.queuing': 'Queuing…',
    'nrsOps.footer': 'All queue operations are logged. Re-submit actions are rate-limited per admin key.',
  ...
  pidgin: {
    ...
    // NRS Operations Center
    'nrsOps.pageTitle': 'NRS Operations Center',
    'nrsOps.pageDesc': 'Real-time monitoring for NRS (Nigeria Revenue Service) submissions',
    'nrsOps.autoRefresh': 'E dey auto-refresh every 10 s',
    'nrsOps.health.title': 'NRS Submission Health — Last 24 Hours',
    'nrsOps.health.successful': '{count} successful',
    'nrsOps.health.failed': '{count} failed',
    'nrsOps.health.pending': '{count} pending',
    'nrsOps.health.total': 'Total: {count}',
    'nrsOps.queue.section': 'Queue Status',
    'nrsOps.queue.unavailable': 'Queue data no available — Redis fit still dey start.',
    'nrsOps.queue.failedCount': '{count} failed',
    'nrsOps.queue.waiting': 'waiting',
    'nrsOps.queue.active': 'active',
    'nrsOps.queue.done': 'done',
    ...
    'nrsOps.table.heading': 'Failed / Pending Submissions',
    'nrsOps.table.totalCount': '{count} total',
    'nrsOps.table.empty': 'No failed submissions — NRS pipeline dey healthy',
    'nrsOps.table.col.invoice': 'Invoice #',
    'nrsOps.table.col.status': 'Status',
    'nrsOps.table.col.amount': 'Amount (₦)',
    'nrsOps.table.col.error': 'Error',
    ...
    'nrsOps.table.resubmit': 'Re-submit',
    'nrsOps.table.queuing': 'Queuing…',
    'nrsOps.footer': 'All queue operations dey logged. Re-submit actions get rate limit per admin key.',
