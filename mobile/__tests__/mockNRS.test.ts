/**
 * TaxBridge Mock NRS Service Unit Tests
...
} from '../src/services/mockNRS';

describe('Mock NRS Service', () => {
  describe('stampInvoiceMock', () => {
    ...
    it('should include educational disclaimer', async () => {
      ...
      expect(response.disclaimer).toContain('NOT AN OFFICIAL NRS/DIGITAX STAMP');
    });
  ...
  describe('getMockAPIEndpoints', () => {
    ...
    it('should include educational note', () => {
      ...
      expect(endpoints.note.toLowerCase()).toContain('mock');
      expect(endpoints.note.toLowerCase()).toContain('educational');
    });
  });
