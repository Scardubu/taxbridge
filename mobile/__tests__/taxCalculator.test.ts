...
describe('Tax Calculator - Nigeria Tax Act 2025', () => {
  describe('PIT Bands Configuration', () => {
    ...
    it('should have correct band limits (NTA 2025)', () => {
    ...
    it('should have correct rates (NTA 2025)', () => {
  ...
  describe('calculatePIT', () => {
    ...
    it('should calculate tax correctly for ₦1M', () => {
      // Income: ₦1,000,000
      // Band 1: ₦800,000 @ 0% = ₦0
    ...
    it('should calculate tax correctly for ₦3M', () => {
      // Income: ₦3,000,000
      // Band 1: ₦800,000 @ 0% = ₦0
    ...
    it('should calculate tax correctly for ₦5M', () => {
      // Income: ₦5,000,000
      // Band 1: ₦800,000 @ 0% = ₦0
      // Band 2: ₦2,200,000 @ 15% = ₦330,000 (₦800k to ₦3M)
      // Band 3: ₦2,000,000 @ 18% = ₦360,000 (₦3M to ₦5M)
      // Total: ₦690,000
    ...
    it('should calculate tax correctly for ₦12M', () => {
      // Income: ₦12,000,000
      // Band 1: ₦800,000 @ 0% = ₦0
      // Band 2: ₦2,200,000 @ 15% = ₦330,000 (₦800k to ₦3M)
      // Band 3: ₦9,000,000 @ 18% = ₦1,620,000 (₦3M to ₦12M)
      // Total: ₦1,950,000
    ...
    it('should calculate tax correctly for ₦25M', () => {
      ...
      // Band 2: ₦2,200,000 @ 15% = ₦330,000 (₦800k to ₦3M)
      // Band 3: ₦9,000,000 @ 18% = ₦1,620,000 (₦3M to ₦12M)
      // Band 4: ₦13,000,000 @ 21% = ₦2,730,000 (₦12M to ₦25M)
      // Total: ₦4,680,000
    ...
    it('should calculate tax correctly for ₦100M (high earner)', () => {
      // Income: ₦100,000,000
      // Bands 1-5: ₦10,430,000 (first ₦50M)
      // Band 6: ₦50,000,000 @ 25% = ₦12,500,000 (above ₦50M)
      // Total: ₦22,930,000
  ...
  describe('checkCITRate', () => {
    it('should return 0% for small companies (≤₦25M)', () => {
      const result = checkCITRate(20_000_000);
      expect(result.rate).toBe(0);
      expect(result.descriptionCode).toBe('small');
    });

    it('should return 0% at exactly ₦25M', () => {
      const result = checkCITRate(25_000_000);
      expect(result.rate).toBe(0);
    });

    it('should return 20% for medium companies (₦25M-₦100M)', () => {
    ...
    it('should handle edge case at ₦25,000,001', () => {
      const result = checkCITRate(25_000_001);
      expect(result.rate).toBe(0.20);
    });
  ...
  describe('Integration Tests', () => {
    ...
    it('should verify VAT + CIT for growing business', () => {
      ...
      // Medium company CIT rate (₦80M is between ₦25M and ₦100M)
